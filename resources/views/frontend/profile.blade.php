	...
	<div class="col-lg-9 border border-secondary my-3" style="background-color: silver;">
		...
		<div class="offset-md-2 col-md-8">
			<form enctype="multipart/form-data" method="" action="{{route('login')}}">
				...
				<div class="form-group">
					<input type="password" class="form-control form-control-user"placeholder="Password" name="user_password" value="1234">
				</div>

				<div class="form-group">
					<input type="password" class="form-control form-control-user"placeholder="Confirm Password" name="user_cpassword" value="1234">
				</div>

				<div class="form-group">
					<input type="number" class="form-control form-control-user"placeholder="Phone Number" name="user_phone" value="0993443443">
				</div>
